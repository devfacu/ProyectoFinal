...
public interface TaskRepository extends JpaRepository<Task, String> {
	...
	@Query("SELECT c FROM Task c WHERE c.project.id = :project_id AND c.done = :done")
	List<Task> findByIdAndDone(@Param("project_id") String project_id, @Param("done") Boolean done);
